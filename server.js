...
app.post('/generate-code', async (req, res) => {
    ...
    console.log('Code genere - ' + property_name + ' | PIN: ' + pin);
...
app.post('/activate-code', async (req, res) => {
    ...
    const log = createLogger('sabimmo');
    ...
    try {
        ...
        console.log('Code active: ' + entry.pin);
...
app.listen(PORT, () => {
    console.log('SABIMMO Atrium API - Port ' + PORT + ' - Pret');
});
